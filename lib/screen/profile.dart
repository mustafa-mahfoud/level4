...
import 'package:level4/getdata.dart';
            ...
            body: Column(
              children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text(
                                userdata["folloers"].length == null
                                    ? "0"
                                    : userdata["folloers"].length.toString(),
                                //follers.toString(),
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 25,
                          ...
                          Column(
                            children: [
                              Text(
                                userdata["folloing"].length == null
                                    ? "0"
                                    : userdata["folloing"].length.toString(),
                              //  folling.toString(),
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 25,
                ...
                Container(
                  ...
                  child: Text(userdata["title"], textAlign: TextAlign.start),
                ),
                SizedBox(height: 20),
                Divider(
                  thickness: widthScreen > 600 ? 0.5 : 0.3,
                  color: Colors.grey,
                ),
                SizedBox(height: 20),
                ...
                Expanded(
                  child: Container(
                    ...
                    margin: widthScreen > 600
                        ? EdgeInsets.symmetric(horizontal: widthScreen / 10)
                        : EdgeInsets.all(10),
